 ...
 */
public class Death extends Pane {
    /**
    ...
    double spriteRows = 9;//how many sprite rows
    ...
    double animSpeed = 200; //pacman chomp speed, lower is faster
    ...
    int frameCount = 8; //frame count for any animation
    int frameStart;
     ...
     */
    Death(boolean animate, String direction,Type type) {
